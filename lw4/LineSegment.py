...
class LineSegment(AbstractGraphicalObject):
   def __init__(self, start_point: Point = None, end_point: Point = None):
        ...
        super().__init__(hotPoints=[start_point, end_point], hotPointSelected=[True, True], selected=False, listeners=[])
   ...
   def getBoundingBox(self) -> Rectangle:
        ...
        print(f"Calculated bounding box: minX={minX}, minY={minY}, width={maxX-minX}, height={maxY-minY}")
